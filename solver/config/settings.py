...
class AppConfig:
    ...
    def validate(self) -> tuple[bool, list[str]]:
        ...
        if self.priority.config_file and not os.path.exists(self.priority.config_file):
            errors.append(f"Priority config file does not exist: {self.priority.config_file}")
...
def load_config(
    ...
    if config.priority.config_file:
        ...
        try:
            ...
            config.priority.priority_config = load_priority_config_from_dict(priority_dict)
