...
```
```text
### Browser `default` opened with pid 3556.
- default:
...
### Snapshot
- [Snapshot](.playwright-cli/page-2026-02-11T11-54-03-594Z.yml)
```
...
- Page Title: Priority Configuration Editor v2
### Snapshot
- [Snapshot](.playwright-cli/page-2026-02-11T11-54-03-668Z.yml)
```
...
- Page Title: Priority Configuration Editor v2
### Snapshot
- [Snapshot](.playwright-cli/page-2026-02-11T11-54-05-827Z.yml)
### Ran Playwright code
```js
// Press ArrowRight
...
- Page Title: Priority Configuration Editor v2
### Snapshot
- [Snapshot](.playwright-cli/page-2026-02-11T11-54-07-131Z.yml)
```
...
- Page Title: Priority Configuration Editor v2
### Snapshot
- [Snapshot](.playwright-cli/page-2026-02-11T11-54-09-938Z.yml)
### Page
- Page URL: http://localhost:4174/index.html#edit_data
- Page Title: Priority Configuration Editor v2
### Snapshot
- [Snapshot](.playwright-cli/page-2026-02-11T11-54-10-002Z.yml)
```
...
- Page Title: Priority Configuration Editor v2
### Snapshot
- [Snapshot](.playwright-cli/page-2026-02-11T11-54-11-321Z.yml)
```
...
- Page URL: http://localhost:4174/index.html#edit_data
- Page Title: Priority Configuration Editor v2
- Console: 6 errors, 3 warnings
### Events
- New console entries: .playwright-cli/console-2026-02-11T11-54-03-077Z.log#L1-L48
### Result
86
### Ran Playwright code
```js
...
- Console: 6 errors, 3 warnings
### Snapshot
- [Snapshot](.playwright-cli/page-2026-02-11T11-54-19-914Z.yml)
### Ran Playwright code
```js
await page.getByRole('tab', { name: 'Edit Data' }).click();
```
...
- Console: 6 errors, 3 warnings
### Snapshot
- [Snapshot](.playwright-cli/page-2026-02-11T11-54-21-024Z.yml)
### Ran Playwright code
```js
await (async page => { const sel = page.locator('select').first(); await sel.selectOption({ label: 'data_equipment.csv' }); await page.waitForTimeout(150); })(page);
```
...
- Console: 6 errors, 3 warnings
### Snapshot
- [Snapshot](.playwright-cli/page-2026-02-11T11-54-26-615Z.yml)
### Ran Playwright code
```js
...
- Page URL: http://localhost:4174/index.html#configuration
- Page Title: Priority Configuration Editor v2
- Console: 6 errors, 6 warnings
### Events
- New console entries: .playwright-cli/console-2026-02-11T11-54-03-077Z.log#L49-L51
### Result
- [Console](.playwright-cli/console-2026-02-11T11-54-28-073Z.log)
```
